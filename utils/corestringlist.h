...
CORESTRING_LWC_STRING(protocol);
CORESTRING_LWC_STRING(host);
CORESTRING_LWC_STRING(hostname);
CORESTRING_LWC_STRING(port);
CORESTRING_LWC_STRING(pathname);
CORESTRING_LWC_STRING(hash);
CORESTRING_LWC_STRING(URL);
CORESTRING_LWC_STRING(URLSearchParams);
CORESTRING_LWC_STRING(searchParams);
CORESTRING_LWC_STRING(characterSet);
CORESTRING_LWC_STRING(contentType);
CORESTRING_LWC_STRING(tabIndex);
CORESTRING_LWC_STRING(visibilityState);
CORESTRING_LWC_STRING(visible);
...
CORESTRING_DOM_STRING(Console);
CORESTRING_DOM_STRING(ConsoleTimers);
CORESTRING_DOM_STRING(Context2D);
CORESTRING_DOM_STRING(DATA);
CORESTRING_DOM_STRING(DOMImplementation);
CORESTRING_DOM_STRING(EVENT_MAP);
CORESTRING_DOM_STRING(EVENT_LISTENER_JS_MAP);
CORESTRING_DOM_STRING(GENERICS_TABLE);
CORESTRING_DOM_STRING(HANDLER_LISTENER_MAP);
CORESTRING_DOM_STRING(HANDLER_MAP);
CORESTRING_DOM_STRING(History);
CORESTRING_DOM_STRING(INIT);
CORESTRING_DOM_STRING(Location);
CORESTRING_DOM_STRING(NODE_MAP);
CORESTRING_DOM_STRING(Navigator);
CORESTRING_DOM_STRING(PROTO_MAP);
CORESTRING_DOM_STRING(Screen);
CORESTRING_DOM_STRING(THREAD_MAP);
CORESTRING_DOM_STRING(WindowCallbacks);
CORESTRING_DOM_STRING(attributes);
CORESTRING_DOM_STRING(childNodes);
CORESTRING_DOM_STRING(classList);
CORESTRING_DOM_STRING(closedownThread);
CORESTRING_DOM_STRING(dataset);
CORESTRING_DOM_STRING(locationbar);
CORESTRING_DOM_STRING(menubar);
CORESTRING_DOM_STRING(personalbar);
CORESTRING_DOM_STRING(scrollbars);
CORESTRING_DOM_STRING(statusbar);
CORESTRING_DOM_STRING(toolbar);
CORESTRING_DOM_STRING(protocol);
CORESTRING_DOM_STRING(host);
CORESTRING_DOM_STRING(hostname);
CORESTRING_DOM_STRING(port);
CORESTRING_DOM_STRING(pathname);
CORESTRING_DOM_STRING(search);
CORESTRING_DOM_STRING(hash);
CORESTRING_DOM_STRING(URL);
CORESTRING_DOM_STRING(URLSearchParams);
CORESTRING_DOM_STRING(searchParams);
CORESTRING_DOM_STRING(characterSet);
CORESTRING_DOM_STRING(contentType);
CORESTRING_DOM_STRING(hidden);
CORESTRING_DOM_STRING(tabIndex);
CORESTRING_DOM_STRING(visibilityState);
CORESTRING_DOM_STRING(visible);
