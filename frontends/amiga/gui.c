		...
		gui_window_create_flags flags)
{
	...
	if(!nsoption_bool(kiosk_mode))
	{
		...
		ami_get_theme_filename(nav_west, sizeof(nav_west), "theme_nav_west", false);
		ami_get_theme_filename(nav_west_s, sizeof(nav_west_s), "theme_nav_west_s", false);
		ami_get_theme_filename(nav_west_g, sizeof(nav_west_g), "theme_nav_west_g", false);
		ami_get_theme_filename(nav_east, sizeof(nav_east), "theme_nav_east", false);
		ami_get_theme_filename(nav_east_s, sizeof(nav_east_s), "theme_nav_east_s", false);
		ami_get_theme_filename(nav_east_g, sizeof(nav_east_g), "theme_nav_east_g", false);
		ami_get_theme_filename(stop, sizeof(stop), "theme_stop", false);
		ami_get_theme_filename(stop_s, sizeof(stop_s), "theme_stop_s", false);
		ami_get_theme_filename(stop_g, sizeof(stop_g), "theme_stop_g", false);
		ami_get_theme_filename(reload, sizeof(reload), "theme_reload", false);
		ami_get_theme_filename(reload_s, sizeof(reload_s), "theme_reload_s", false);
		ami_get_theme_filename(reload_g, sizeof(reload_g), "theme_reload_g", false);
		ami_get_theme_filename(home, sizeof(home), "theme_home", false);
		ami_get_theme_filename(home_s, sizeof(home_s), "theme_home_s", false);
		ami_get_theme_filename(home_g, sizeof(home_g), "theme_home_g", false);
		ami_get_theme_filename(closetab, sizeof(closetab), "theme_closetab", false);
		ami_get_theme_filename(closetab_s, sizeof(closetab_s), "theme_closetab_s", false);
		ami_get_theme_filename(closetab_g, sizeof(closetab_g), "theme_closetab_g", false);
		ami_get_theme_filename(addtab, sizeof(addtab), "theme_addtab", false);
		ami_get_theme_filename(addtab_s, sizeof(addtab_s), "theme_addtab_s", false);
		ami_get_theme_filename(addtab_g, sizeof(addtab_g), "theme_addtab_g", false);
		ami_get_theme_filename(tabthrobber, sizeof(tabthrobber), "theme_tab_loading", false);
		ami_get_theme_filename(fave, sizeof(fave), "theme_fave", false);
		ami_get_theme_filename(unfave, sizeof(unfave), "theme_unfave", false);
		ami_get_theme_filename(pi_insecure, sizeof(pi_insecure), "theme_pageinfo_insecure", false);
		ami_get_theme_filename(pi_internal, sizeof(pi_internal), "theme_pageinfo_internal", false);
		ami_get_theme_filename(pi_local, sizeof(pi_local), "theme_pageinfo_local", false);
		ami_get_theme_filename(pi_secure, sizeof(pi_secure), "theme_pageinfo_secure", false);
		ami_get_theme_filename(pi_warning, sizeof(pi_warning), "theme_pageinfo_warning", false);
